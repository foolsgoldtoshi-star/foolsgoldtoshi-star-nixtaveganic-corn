...
site.core.gen_page = (function site$core$gen_page(p__7382){
var map__7383 = p__7382;
var map__7383__$1 = cljs.core.__destructure_map(map__7383);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7383__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var ast = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7383__$1,new cljs.core.Keyword(null,"ast","ast",-860334068));
...
})(),new cljs.core.Keyword(null,"body","body",-2049205669),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__7380_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__7380_SHARP_),new cljs.core.Keyword(null,"h1","h1",-1896887462));
}),ast)], null);
...
var docs_dir = "../docs";
var files = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__7388_SHARP_){
return site.core.path.join(docs_dir,p1__7388_SHARP_);
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__7387_SHARP_){
return clojure.string.ends_with_QMARK_(p1__7387_SHARP_,".md");
...
var sitemap = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__7393_SHARP_){
return cljs.core.select_keys(p1__7393_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"title","title",636505583)], null));
}),pages);
var _ = site.core.ensure_dir_BANG_("../web/src/lib/generated");
var ___$1 = site.core.ensure_dir_BANG_("../web/static/content");
var seq__7401_7410 = cljs.core.seq(pages);
var chunk__7402_7411 = null;
var count__7403_7412 = (0);
var i__7404_7413 = (0);
while(true){
if((i__7404_7413 < count__7403_7412)){
var page_7414 = chunk__7402_7411.cljs$core$IIndexed$_nth$arity$2(null,i__7404_7413);
site.core.gen_page(page_7414);


var G__7415 = seq__7401_7410;
var G__7416 = chunk__7402_7411;
var G__7417 = count__7403_7412;
var G__7418 = (i__7404_7413 + (1));
seq__7401_7410 = G__7415;
chunk__7402_7411 = G__7416;
count__7403_7412 = G__7417;
i__7404_7413 = G__7418;
continue;
} else {
var temp__5804__auto___7419 = cljs.core.seq(seq__7401_7410);
if(temp__5804__auto___7419){
var seq__7401_7420__$1 = temp__5804__auto___7419;
if(cljs.core.chunked_seq_QMARK_(seq__7401_7420__$1)){
var c__5525__auto___7421 = cljs.core.chunk_first(seq__7401_7420__$1);
var G__7422 = cljs.core.chunk_rest(seq__7401_7420__$1);
var G__7423 = c__5525__auto___7421;
var G__7424 = cljs.core.count(c__5525__auto___7421);
var G__7425 = (0);
seq__7401_7410 = G__7422;
chunk__7402_7411 = G__7423;
count__7403_7412 = G__7424;
i__7404_7413 = G__7425;
continue;
} else {
var page_7426 = cljs.core.first(seq__7401_7420__$1);
site.core.gen_page(page_7426);


var G__7427 = cljs.core.next(seq__7401_7420__$1);
var G__7428 = null;
var G__7429 = (0);
var G__7430 = (0);
seq__7401_7410 = G__7427;
chunk__7402_7411 = G__7428;
count__7403_7412 = G__7429;
i__7404_7413 = G__7430;
continue;
}
} else {
}
...
site.core.spit_STAR_("../web/static/content/sitemap.json",JSON.stringify(cljs.core.clj__GT_js(sitemap),null,(2)));

var exports_7431__$1 = clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__7396_SHARP_){
return ["export { default as Page",clojure.string.replace(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__7396_SHARP_),/[^a-zA-Z0-9]/,"_")," } from './",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__7396_SHARP_)),".svelte';"].join('');
}),pages));

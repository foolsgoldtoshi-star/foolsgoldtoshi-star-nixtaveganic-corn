...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_7234 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_7234(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_7235 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_7235(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_7237 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_7237(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_7241 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_7241(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_7248 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_7248(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_7252 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_7252(h);
}
});
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_7260(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_7265 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_7265(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_7271 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_7271(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_7275 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_7275(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_7282 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_7282(b);
}
});
